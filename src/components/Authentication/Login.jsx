    ...
    return (
     ...
     <div style={{ backgroundImage: `url(${"https://images.squarespace-cdn.com/content/v1/5fe4caeadae61a2f19719512/1609959468995-0O6J0ZCLAKJYZPGQB4KR/5.jpg"})`}} className="bg-cover bg-center">
        ...
        <Nav></Nav>
           ...
           <div className="w-full max-w-md my-10 p-8 space-y-3 rounded-xl mx-auto h-full  bg-gray-400  bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button className="block w-full p-3 text-center rounded-sm text-white bg-orange-2">Sign in</button>
        </form>
        ...
        {/* google Login */}
       <SocialLogin/>
        <p className="text-sm text-center sm:px-6 text-white">Don not have an account?
            <NavLink to='/register' rel="noopener noreferrer" href="#" className="underline text-orange-2"> Register</NavLink>
        </p>
    </div>
        <Footer/>
     </div>
